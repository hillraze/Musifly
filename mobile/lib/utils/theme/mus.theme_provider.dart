...
class MusThemeProvider extends ChangeNotifier {
  MusThemeProvider(this._MusTheme);

  bool _mounted = true;

  MusTheme _MusTheme;

  MusTheme get musTheme => _MusTheme;

  void setNewTheme(MusTheme theme) {
    _MusTheme = theme;
  }
...
extension MusThemeBuildContextExtension on BuildContext {
  MusTheme get musTheme {
    return Provider.of<MusThemeProvider>(this, listen: false)._MusTheme;
  }

  void changeTheme(MusTheme? value) {
    if (value != null) {
      final musThemeProvider =
          Provider.of<MusThemeProvider>(this, listen: false);
      musThemeProvider._MusTheme = value;
      musThemeProvider.notifyListeners();
    }
  }
